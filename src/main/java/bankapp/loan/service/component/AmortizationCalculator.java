...
import bankapp.loan.model.common.repayment.RepaymentDetail;
...
public class AmortizationCalculator {
    ...
    public List<RepaymentDetail> calculate(LoanContract loanContract) {
        ...
        BigDecimal totalAppliedRate = loanContract.getAppliedBaseRate()
                .add(loanContract.getAppliedProductSpread())
                .add(loanContract.getAppliedCreditSpread());
